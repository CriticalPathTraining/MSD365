...
export default class SpaAuthService {
    ...
    public static userAgent: Msal.UserAgentApplication = new Msal.UserAgentApplication(SpaAuthService.msalConfig);
    ...
    private static acquireAccessokenxxx() {
        SpaAuthService.userAgent.acquireTokenSilent(SpaAuthService.requestScopes)
            .then(function (tokenResponse) {
                ...
                console.log(error);
                if (SpaAuthService.requiresInteraction(error.errorCode)) {
                    SpaAuthService.userAgent.acquireTokenPopup(SpaAuthService.requestScopes).then((tokenResponse) => {
                        console.log("Access token acquired interactively...");
