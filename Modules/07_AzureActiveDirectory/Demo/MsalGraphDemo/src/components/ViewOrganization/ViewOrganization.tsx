...
import MicrosoftGraphService, { IGraphOrganization } from "./../../services/MicrosoftGraphService";

interface ViewOrganizationProperties {
}

interface ViewOrganizationState {
    organization: IGraphOrganization;
    loading: boolean;
}
...
export default class ViewCurrentUser extends React.Component<ViewOrganizationProperties, ViewOrganizationState> {
    ...
    getOrganization = () => {
        MicrosoftGraphService.GetOrganizationDetails().then((organization: IGraphOrganization) => {
